defmodule PlanterWeb.UserAuthTest do
  use PlanterWeb.ConnCase, async: true

  alias Planter.Accounts
  alias Planter.Accounts.Scope
  alias PlanterWeb.UserAuth

  import Planter.AccountsFixtures

  @remember_me_cookie "_planter_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PlanterWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
