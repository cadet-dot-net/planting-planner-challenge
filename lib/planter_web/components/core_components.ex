defmodule PlanterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PlanterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PlanterWeb.Gettext, "errors", msg, opts)
    end
  end
